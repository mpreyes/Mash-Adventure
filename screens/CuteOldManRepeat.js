...
export default class CuteOldManRepeatScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>{'\t'}You ask Gilbert to repeat the question. He gives you
        a funny look and repeats the question again.</Text>
