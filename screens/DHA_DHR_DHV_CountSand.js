...
export default class DHA_DHR_DHV_CountSandScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
    ...
    <Text style={{fontStyle: "italic",}}> thought </Text> he had been locked in a room by a talking fox.) You accept your fate and head to window to look outside.
     It was getting brighter now, which meant you could start the arduous task of counting. Almost immediately, you begin to feel hungry. Outside is a small 
    ...
    to the scale as carefully as possible. The wind from the window doesn't help. Your head aches from the hunger and exhaustion.
    The sun sets after a full day of working and you didn't even finish counting half of the sand. You lay down on the floor of dark tower alone. "You are not worthy." are the last words you hear before everything turns black.
    {'\n'}
