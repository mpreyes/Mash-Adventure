...
export default class DHA_DHR_DontHelpRavenScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
    ...
    your head, and on the other side next to another door sits a scale and a small box, among other things. There's a rope fixed to the scale and box that stretches out 
    to the ceiling of the room. You hadn't realized that the fox had not followed you in until- "Good luck human. Only fifty thousand grains of sand will open the box." 
    The door closes, and you hear the fox start the long climb downstairs. "Wait!" you call. "You lied to me! Where's the wizard? And what happened to the lady that was dying?" No answer. You're stuck in the room.
     </Text>
  ...
  <Button  title="Begin to count the sand"  color="#1698bc"  onPress={() =>
      navigate('DHA_DHR_DHV_CountSand', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
