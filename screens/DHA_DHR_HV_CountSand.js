...
export default class DHA_DHR_HV_CountSandScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
    ...
    After almost a full day of the tedious work, you finally reach the number you need for the scale to tip and a key to fall from the ceiling.  
    The key is too small to fit in the doors, so you try it on the box. Unfortunately, the box does not contain the key to said doors. It's simply
    a small seed. Too frustrated to think properly, you throw the seed out the window and lay on the floor. The sun sets, and you're left in the 
    dark room alone. "You are not worthy." are the last words you hear before everything turns black.
    {'\n'}
    </Text>
