...
export default class DHA_DHR_RavenWithNutScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>( you didnt help the ants or the rabbit) You decide you'd better try to find the fox.</Text>
  ...
  <Button  title="The bird can fend for himself"  color="#1698bc"  onPress={() =>
      navigate('DHA_DHR_DontHelpRaven', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
