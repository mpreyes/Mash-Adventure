...
export default class DHA_HR_HV_AnswerRiddleScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
    ...
    <Animatable.View animation="fadeInDown"  direction="alternate" style={{flex: 2}}>
     ...
     <Text style={styles.questionStyling}>
     You look around the room for clues, but see nothing. Time seems to move slowly.... you don't have an answer for him. The lion 
     hums a tune and strolls up to you.
     The last words you hear before everything goes black and you become this lion's lunch are <Text style={{fontStyle: "italic",}}>"Then you'll be left in the dust..."</Text>
     </Text>
