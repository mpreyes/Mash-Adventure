...
export default class DontHelpAntsScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}> The ants can fend for themselves, you think.</Text>




    <Text style={styles.questionStyling}>
    {'\t\t'} You finish crossing the stream and catch up with the fox.
    He gives you a look of impatience. "We're trying to get there today, human. Keep up." And with that he's off again,
