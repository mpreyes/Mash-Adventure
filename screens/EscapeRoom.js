...
export default class EscapeRoomScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>Without a second glance, the raven flies off and leaves you. You think it best to find another way
        out of the tower.</Text>
    ...
    <Text style={styles.questionStyling}> You step away from the window to look around for something that can help you escape.
     You look around the room and notice a top hat you hadn't seen before. <Text style={{fontStyle: "italic",}}>Weird.</Text> The hat wobbles around for a bit and you stare in amazement. Suddenly, a rabbit hops out of it,
