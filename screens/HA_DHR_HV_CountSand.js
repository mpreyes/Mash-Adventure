...
export default class HA_DHR_HV_CountSandScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>(dont help rabbit) You sit on the floor and catch your breath.</Text>
