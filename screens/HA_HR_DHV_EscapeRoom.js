...
export default class HA_HR_DHV_EscapeRoomScreen extends React.Component {
  constructor(props) {
    super(props);
...
<View style={styles.parentViewStyling}>
    ...
    <Text style={styles.questionStyling}> Nothing immediately comes to mind. You store the seed in your pocket for safekeeping and step away from the window to look around for something that can help you escape.
  ...
  <Button  title="Leave the room"  color="#1698bc"  onPress={() =>
      navigate('DHA_HR_HV_FightMonster', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
