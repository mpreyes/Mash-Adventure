...
export default class PartyScreen extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>After walking for a bit, you hear some music and laughter. Your nostrils are filled with 
        the wonderful aroma of barbacue.</Text>

      <Animatable.View animation="fadeInDown"  direction="alternate" style={styles.adventureImageViewStyling}>
              <Image
            style={{flex:2, height: 350, width: undefined}}
    ...
    <Text style={styles.questionStyling}>Ooh look, a party! Are we going to stay and mingle? </Text>


    <Animatable.View animation="slideInUp" style={styles.adventureGroupButtonStyling}>

      <View style={styles.adventureSoloButtonStyling}>
  <Button  title="Yesss Lets"  color="#1698bc"  onPress={() =>
      navigate('MingleAtParty', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
  ...
  <View style={styles.adventureSoloButtonStyling}>
    <Button title="Lets Head for the snack bar" color="#1698bc"  onPress={() =>
        navigate('Snackbar', {
        profile: profile,
        mash: {
            M: "Mansion",
    ...
    <View style={styles.adventureSoloButtonStyling}>
      <Button title="No, Let's keep going" color="#1698bc"   onPress={() =>
          navigate('TakePathPt1', {
          profile: profile,
          mash: {
              M: "Mansion",
              A: "Apartment",
