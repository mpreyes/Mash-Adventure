...
export default class TakePathPt1Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>You decide that you'd rather keep going and see if there is anything
   ...
   I don't think the game creator planned for this. She assumed you would be like most people and want to 
   enjoy the party. Or even go to the snack bar to stuff your face. Unfortunately, that's not the case.
    So now I guess you'll have walk down this very long path.
     </Text>

    <Animatable.View animation="slideInUp" style={styles.adventureGroupButtonStyling}>
      <View style={styles.adventureSoloButtonStyling}>
  <Button  title="Go down long path"  color="#1698bc"  onPress={() =>
      navigate('TakePathPt2', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
