...
export default class TakePathPt10Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}> "Haha I wouldn't really do that to you."</Text>
