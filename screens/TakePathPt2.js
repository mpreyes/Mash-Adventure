...
export default class TakePathPt2Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}>You continue to walk.</Text>
   ...
   The game creator was out on a tea break and didn't realize you had kept walking. She'll let you keep walking if you 
   really want to.
     </Text>
