...
export default class TakePathPt4Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}> Still walking.</Text>
    ...
    <Text style={styles.questionStyling}>
     "I acknowledge your grit. But really, it's not as interesting as you might think it is down there."
     </Text>
