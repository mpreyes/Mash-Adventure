...
export default class TakePathPt5Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}> Walk. Walk. Walk.</Text>
  ...
  "Oh look a bird! And its going back in the direction of the party!" It seems different from any bird you've ever seen before.
  ...
  <Button  title="Follow the bird"  color="#1698bc"  onPress={() =>
      navigate('Party', {
      profile: profile,
      mash: {
          M: "Mansion",
  ...
  <View style={styles.adventureSoloButtonStyling}>
  <Button  title="Nope, keep walking"  color="#1698bc"  onPress={() =>
      navigate('TakePathPt6', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
