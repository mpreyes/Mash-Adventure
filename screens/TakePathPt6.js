...
export default class TakePathPt6Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}> "Okay fine, it was just an ordinary bird heading back to it's tree."</Text>
    ...
    You keep at it. Your feet are starting to hurt.
     </Text>

    <Animatable.View animation="slideInUp" style={styles.adventureGroupButtonStyling}>
      <View style={styles.adventureSoloButtonStyling}>
  <Button  title="Walk through the pain"  color="#1698bc"  onPress={() =>
      navigate('TakePathPt7', {
      profile: profile,
      mash: {
          M: "Mansion",
          A: "Apartment",
