...
export default class TakePathPt7Screen extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      <ScrollView style={styles.textStyling}>
        <Text style={styles.questionStyling}> Oh look! A little old lady needs your help to walk back to the party!</Text>

      <Animatable.View animation="fadeInDown"  direction="alternate" style={{flex: 2}}>
              <Image
            style={{flex:1, height: 350, width: undefined}}
            source={require('../images/old_lady.png')}
            resizeMethod="resize"
            resizeMode="contain"
          />
      </Animatable.View>
  ...
  <Button  title="Help the old lady walk back"  color="#1698bc"  onPress={() =>
      navigate('Party', {
      profile: profile,
      mash: {
          M: "Mansion",
