...
<View style={styles.parentViewStyling}>
     ...
     {'\t\t'} You're not sure what brought this feeling on, but you have a nagging feeling that the fox wants to trick you.
     You shake your head and apologize. "Sorry, I'm not sure I've seen him." he gives you a curious look and seems to pause 
    ...
    {'\n'}
     ...
     <Text style={styles.questionStyling}>
     {'\t\t'} After some time has passed, you hear more noises in the grass. At first, you assume its the fox coming back
     to get you to follow him, until you hear the distict sound of barking in the distance. The derpiest dog in existence has 
  ...
  <Button  title="Go with dog"  color="#1698bc"  onPress={() =>
